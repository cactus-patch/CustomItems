...
public static class Utils {
	...
	public static void AddCandy1126(byte CandyId, Player player)
	{
		CandyKindID CandyColor;
		switch(CandyId)
		{
			default:
				CandyColor = CandyKindID.Red;
				break;
			case(1):
				CandyColor = CandyKindID.Rainbow;
				break;
			case(2):
				CandyColor = CandyKindID.Yellow;
				break;
			case(3):
				CandyColor = CandyKindID.Purple;
				break;
			case(4):
				CandyColor = CandyKindID.Green;
				break;
			case(5):
				CandyColor = CandyKindID.Blue;
				break;
			case(6):
				CandyColor = CandyKindID.Pink; // Make this VERY VERY rare
				break;
		}

		player.TryAddCandy(CandyColor);
